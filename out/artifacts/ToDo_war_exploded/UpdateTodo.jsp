        ...
        <section>
            <div class = "neu_filter">
                ...
                <div class = "neu_filter_form" id = "neues_todo" >
                    <form action="UpdateTodoWithInputs.do" method="get">
                        Title<br>
                        <input name = "title" style = "width: 90%;" value = "${currentTodo.getTitle()}" required><br>
                        Category<br>
                        <input name = "category" style = "width: 90%;" value = "${currentTodo.getEmptyCategoryIfEmpty()}" ><br>
                        Due Date<br>
                        <input name = "dueDate" style = "width: 90%;" type = "date" value="${currentTodo.getInternationalFormattedDate()}" ><br>
                        Important<br>
                        <input name = "important" style = "width: 90%;" type = "checkbox" ${currentTodo.getImportantOnIfChecked()} ><br><br>
                        <input name = "id"  value = "${currentTodo.getId()}" hidden>
                        <input type="submit" value="Update current Todo"/>
                    </form>
                </div>
            </div>
        </section>
